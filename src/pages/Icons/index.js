        ...
        <div className="col-md-12">
          <div className="card">
            <div className="header">
              ...
              <p className="category">Handcrafted by our friends from <a  rel="opener"  target="_blank" href="http://themes-pixeden.com/font-demos/7-stroke/index.html">Pixeden</a></p>
            </div>
